    ...
    <div class="card recent-sales overflow-auto">
        <div class="card-body">
            <div class="d-flex flex-row justify-content-between">
                <div>
                    <h5 class="card-title">Total Seluruh OPD|POP <span>: {{ $odp->count() }} OPD|POP</span></h5>
                </div>
                <div class="p-3">
            ...
            <table class="table table-borderless datatable">
                <thead>
                    <tr>
                        <th scope="col">#</th>
                        <th scope="col">Kode OPD|POP</th>
                        <th scope="col">Nama OPD|POP</th>
                ...
                <tbody>
                    @foreach($odp as $no => $data)
                    <tr>
                        <div hidden>{{ $id = $data['id'] }}</div>
                        <th scope="row">{{ $no+1 }}</th>
                        <td>{{ $data['kode_odp'] ?? 'Data kosong' }}</td>
                        ...
                        <td class="">
                            ...
                            <a href="{{ $data['maps'] }}" target="_blank" type="button" data-bs-toggle="tooltip" data-bs-placement="top"
                                title="Maps ODP" class="p-0" style="background: transparent; border: none;">
                        ...
                        <td class="d-flex flex-row justify-content">
                            <a href="{{ route('edit.odp', $id) }}" class="btn btn-primary btn-sm"><i
                                    class="bi bi-pencil-square"></i></a>
                            <a href="{{ route('delete.odp', $id) }}" type="button" data-bs-toggle="tooltip"
